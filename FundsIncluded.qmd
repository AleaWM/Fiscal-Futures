...
Preliminary expenditure and revenue data is requested after the Fiscal Year ends, and the requested again at the end of the lapse period.[^index-1] Calculations are based off the values received from the data received after October 31st when Illinois' lapse period ends.

[^index-1]: "Closed" year:  accounts have been reconciled and reported as final.
