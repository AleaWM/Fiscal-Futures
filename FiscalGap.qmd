...
For details on how tables and graphs were created, please see the Methodology tab.

> This page is supposed to be a simplified version of the @sec-all-code page.

> Add final summary tables and link to the paper.
