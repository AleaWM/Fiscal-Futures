...
> Every section is a work in progress and will continue to be updated. - AWM 2/20/2023

This is a living document in which we aim to describe things as clearly as possible in the time we have, share it with others, and improve each time we come back to it. If we wait till we have time to write flawless documents, it'll never happen.

The Fiscal Futures Project is associated with the University of Illinois' Institute of Government and Policy Affairs, but creating the R code, publicly sharing the code, and creating a website for methodology was done by Alea Wilbur-Mujtaba. Any errors with code or findings are the fault of the author, not the research institute. Data is originally from annual FOIA requests to the Illinois Office of the Comptroller.

Read the paper [here.](https://igpa.uillinois.edu/) (forthcoming, will update link once published - AWM 2/14/2023)
