...
This page describes the creation of `allexp_fy22_recoded_LASTDATEMODIFIED.csv` and `allrev_fy22_recoded_LASTDATEMODIFIED.csv`.
:::
...
## if similar to data that was inheritied before joining the project, then I would apply it to FY19 to current FY to see if any revenue sources should have been coded as "local" or "amnesty"
