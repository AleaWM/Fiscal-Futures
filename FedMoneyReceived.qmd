...
![State CURE expenditures and allocations](images/bothgraphs.png){#fig-revandCUREexp}
...
> Images below are wrong (Transportation is wrong and should be essentially dropped, FFCRA received year is wrong. \$30 billion in federal funds.)

![The image above shows the federal revenue type, the year it was received, and type of federal revenue source that the funds fall within using the Fiscal Futures methodology.](images/revenues_ioc_32bil_byyear.png){#fig-ioc_received_32bil_byyear}

![The image above shows the federal revenue type (State CURE or other), the year it was received, and the revenue source category it falls under using the Fiscal Futures methodology. It contains the same information as the chart above but the Year and Source type are flipped.](images/revenues_ioc_32bil_byrevsource.png){#fig-received-ioc32bil-byrevsource}
